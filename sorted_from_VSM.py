...
filename = askopenfilename(title = 'Where is your original VSM located?')
dest_filename = asksaveasfilename(title = 'Where would you like to save the resulting abridged file?')
