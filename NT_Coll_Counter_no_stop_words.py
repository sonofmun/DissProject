...
nt_file = askopenfilename(title = 'Where is your NT Lemma File located?')
...
file = os.path.split(nt_file)[1]
print('Now analyzing ', file)
dest_file = os.path.join(coll_dir, '_'.join([file.split('_')[1], 'coll.pickle']))
dict_file = os.path.join(coll_dir, '_'.join([file.split('_')[1], 'coll_dict.pickle']))
