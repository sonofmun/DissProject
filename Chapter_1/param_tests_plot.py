...
class mean_std_chart:
	...
	def build_chart(self):
		...
		plt.axhline(self.y[0], linestyle='solid', label='Mean of Win Size {}'.format(self.x[0]))
		plt.axhline(self.y[0]+self.std*self.e[0], linestyle='--', label='{} STDs above Mean of Win Size {}'.format(self.std, self.x[0]))
		plt.legend(loc=0)
